    ...
    <div class="min-h-full flex items-center justify-center py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center slide-in">
                ...
                <h2 class="text-4xl font-bold text-gradient mb-3">Login Akun Toko</h2>
            </div>

            <!-- Form -->
            <form class="glass-effect rounded-3xl shadow-2xl p-8 space-y-6 slide-in glow-effect" method="POST" style="animation-delay: 0.3s" action="{{ route('login') }}">
                @csrf
                <!-- Email -->
                ...
                <div class="text-center pt-4">
                    <p class="text-sm text-gray-400">
                        Belum punya akun?
                        <a href="/register" class="font-medium text-purple-400 hover:text-purple-300 transition-colors duration-200 ml-1">
                            Daftar di sini
                        </a>
                    </p>
                </div>
